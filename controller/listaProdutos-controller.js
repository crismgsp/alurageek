...
const criaNovaLinha = ( categoria, imagem, nome, preco, id) => {
    ...
    <li class="lista" ><a href ="produtos.html/${id}">
        <img class="fotoproduto" data-imagem src="assets/imagem${id}.png">
...
const render = async () => {
    try{
        ...
        listaProdutos.forEach(elemento => {
            tabela.appendChild(criaNovaLinha(elemento.categoria, elemento.imagem, elemento.nome,elemento.preco, elemento.id ))
        })
    }
    catch(erro) {
        console.log(erro)
